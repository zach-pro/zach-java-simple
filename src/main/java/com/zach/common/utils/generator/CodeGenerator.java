package com.zach.common.utils.generator;
...
public class CodeGenerator {
    ...
    // TODO 项目名称
    private static final String PROJECT_NAME = "zach";
    // TODO 微服务项目模块名（可选，和单体二选一）
    private static final String CLOUD_NAME = "zach";
    // TODO 路径包名（生成的文件放在绝地路径下，为下面路径代码铺垫）
    private static final String PACKAGE_DIR = "/com/zach/modular/";
    // TODO 生成包名
    private static final String PACKAGE_EXE = "com.zach.modular";
    // TODO 数据库地址
    private static final String URL = "jdbc:mysql://localhost:3306/zach?useUnicode=true&characterEncoding =UTF-8&serverTimezone = Asia/Shanghai";
    // TODO 数据库用户名
    private static final String USERNAME = "xxx";
    // TODO 数据库密码
    private static final String PASSWORD = "xxx";
    // TODO  作者
    private static final String AUTHOR = "zach";
    // TODO  去除的表前缀（可选）
