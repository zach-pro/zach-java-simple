...
public class CodeGenerator {
    ...
    private static final String CLOUD_NAME = "sensor";
    // TODO 路径包名（生成的文件放在绝地路径下，为下面路径代码铺垫）
    private static final String PACKAGE_DIR = "/com/sensor/modular/";
    // TODO 生成包名
    private static final String PACKAGE_EXE = "com.sensor.modular";
    // TODO 数据库地址
    private static final String URL = "jdbc:mysql://localhost:3306/sensor?useUnicode=true&characterEncoding =UTF-8&serverTimezone = Asia/Shanghai";
    // TODO 数据库用户名
    private static final String USERNAME = "root";
    // TODO 数据库密码
    private static final String PASSWORD = "root223723";
    // TODO  作者
